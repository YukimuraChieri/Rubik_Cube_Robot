...
"""autogenerated by genpy from central_proc/CubeSolveExecActionResult.msg. Do not edit."""
import codecs
import sys
...
class CubeSolveExecActionResult(genpy.Message):
  _md5sum = "5489bcfa93e36e07a0b801f3ac4c7c97"
  _type = "central_proc/CubeSolveExecActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','central_proc/CubeSolveExecResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CubeSolveExecActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = central_proc.msg.CubeSolveExecResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = central_proc.msg.CubeSolveExecResult()
