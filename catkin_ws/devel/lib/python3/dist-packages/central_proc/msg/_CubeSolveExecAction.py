...
"""autogenerated by genpy from central_proc/CubeSolveExecAction.msg. Do not edit."""
import codecs
import sys
...
class CubeSolveExecAction(genpy.Message):
  _md5sum = "941e514af3e07da21c183457c05111af"
  _type = "central_proc/CubeSolveExecAction"
...
"""
  ...
  _slot_types = ['central_proc/CubeSolveExecActionGoal','central_proc/CubeSolveExecActionResult','central_proc/CubeSolveExecActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CubeSolveExecAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = central_proc.msg.CubeSolveExecActionGoal()
      if self.action_result is None:
        self.action_result = central_proc.msg.CubeSolveExecActionResult()
      if self.action_feedback is None:
        self.action_feedback = central_proc.msg.CubeSolveExecActionFeedback()
    else:
      self.action_goal = central_proc.msg.CubeSolveExecActionGoal()
      self.action_result = central_proc.msg.CubeSolveExecActionResult()
      self.action_feedback = central_proc.msg.CubeSolveExecActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.cmd_list
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_feedback.feedback.now_cmd
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.cmd_list = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.cmd_list = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.action_feedback.feedback.now_cmd = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_feedback.feedback.now_cmd = str[start:end]
      return self
