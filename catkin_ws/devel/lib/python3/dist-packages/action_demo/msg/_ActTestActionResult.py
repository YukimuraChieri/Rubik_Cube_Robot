...
"""autogenerated by genpy from action_demo/ActTestActionResult.msg. Do not edit."""
import codecs
import sys
...
class ActTestActionResult(genpy.Message):
  _md5sum = "5489bcfa93e36e07a0b801f3ac4c7c97"
  _type = "action_demo/ActTestActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action_demo/ActTestResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ActTestActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = action_demo.msg.ActTestResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = action_demo.msg.ActTestResult()
