...
{  	 
  ...
  mantissa<<=4;
	...
	MY_NVIC_Init(3,3,USART2_IRQn,3);//组3，最低优先级 
#endif
}
...
{  	 
	...
	GPIOA->CRH&=0XFFFF00FF;	//IO状态设置
	GPIOA->CRH|=0X00008B00;	//IO状态设置 
	...
	MY_NVIC_Init(3,3,USART3_IRQn,4);//组4，最低优先级 
#endif
}
